...
module Computer_System_mm_interconnect_2 (
		...
		output wire [1:0]  code_rdy_pio_s1_address,                                                  //                                                    code_rdy_pio_s1.address
		input  wire [31:0] code_rdy_pio_s1_readdata,                                                 //                                                                   .readdata
		...
		output wire [1:0]  keyboard_pio_s1_address,                                                  //                                                    keyboard_pio_s1.address
		input  wire [31:0] keyboard_pio_s1_readdata,                                                 //                                                                   .readdata
	...
	wire   [31:0] keyboard_pio_s1_agent_m0_readdata;                                           // keyboard_pio_s1_translator:uav_readdata -> keyboard_pio_s1_agent:m0_readdata
	wire          keyboard_pio_s1_agent_m0_waitrequest;                                        // keyboard_pio_s1_translator:uav_waitrequest -> keyboard_pio_s1_agent:m0_waitrequest
	wire          keyboard_pio_s1_agent_m0_debugaccess;                                        // keyboard_pio_s1_agent:m0_debugaccess -> keyboard_pio_s1_translator:uav_debugaccess
	wire   [20:0] keyboard_pio_s1_agent_m0_address;                                            // keyboard_pio_s1_agent:m0_address -> keyboard_pio_s1_translator:uav_address
	wire    [3:0] keyboard_pio_s1_agent_m0_byteenable;                                         // keyboard_pio_s1_agent:m0_byteenable -> keyboard_pio_s1_translator:uav_byteenable
	wire          keyboard_pio_s1_agent_m0_read;                                               // keyboard_pio_s1_agent:m0_read -> keyboard_pio_s1_translator:uav_read
	wire          keyboard_pio_s1_agent_m0_readdatavalid;                                      // keyboard_pio_s1_translator:uav_readdatavalid -> keyboard_pio_s1_agent:m0_readdatavalid
	wire          keyboard_pio_s1_agent_m0_lock;                                               // keyboard_pio_s1_agent:m0_lock -> keyboard_pio_s1_translator:uav_lock
	wire   [31:0] keyboard_pio_s1_agent_m0_writedata;                                          // keyboard_pio_s1_agent:m0_writedata -> keyboard_pio_s1_translator:uav_writedata
	wire          keyboard_pio_s1_agent_m0_write;                                              // keyboard_pio_s1_agent:m0_write -> keyboard_pio_s1_translator:uav_write
	wire    [2:0] keyboard_pio_s1_agent_m0_burstcount;                                         // keyboard_pio_s1_agent:m0_burstcount -> keyboard_pio_s1_translator:uav_burstcount
	wire          keyboard_pio_s1_agent_rf_source_valid;                                       // keyboard_pio_s1_agent:rf_source_valid -> keyboard_pio_s1_agent_rsp_fifo:in_valid
	wire  [118:0] keyboard_pio_s1_agent_rf_source_data;                                        // keyboard_pio_s1_agent:rf_source_data -> keyboard_pio_s1_agent_rsp_fifo:in_data
	wire          keyboard_pio_s1_agent_rf_source_ready;                                       // keyboard_pio_s1_agent_rsp_fifo:in_ready -> keyboard_pio_s1_agent:rf_source_ready
	wire          keyboard_pio_s1_agent_rf_source_startofpacket;                               // keyboard_pio_s1_agent:rf_source_startofpacket -> keyboard_pio_s1_agent_rsp_fifo:in_startofpacket
	wire          keyboard_pio_s1_agent_rf_source_endofpacket;                                 // keyboard_pio_s1_agent:rf_source_endofpacket -> keyboard_pio_s1_agent_rsp_fifo:in_endofpacket
	wire          keyboard_pio_s1_agent_rsp_fifo_out_valid;                                    // keyboard_pio_s1_agent_rsp_fifo:out_valid -> keyboard_pio_s1_agent:rf_sink_valid
	wire  [118:0] keyboard_pio_s1_agent_rsp_fifo_out_data;                                     // keyboard_pio_s1_agent_rsp_fifo:out_data -> keyboard_pio_s1_agent:rf_sink_data
	wire          keyboard_pio_s1_agent_rsp_fifo_out_ready;                                    // keyboard_pio_s1_agent:rf_sink_ready -> keyboard_pio_s1_agent_rsp_fifo:out_ready
	wire          keyboard_pio_s1_agent_rsp_fifo_out_startofpacket;                            // keyboard_pio_s1_agent_rsp_fifo:out_startofpacket -> keyboard_pio_s1_agent:rf_sink_startofpacket
	wire          keyboard_pio_s1_agent_rsp_fifo_out_endofpacket;                              // keyboard_pio_s1_agent_rsp_fifo:out_endofpacket -> keyboard_pio_s1_agent:rf_sink_endofpacket
	wire          keyboard_pio_s1_agent_rdata_fifo_src_valid;                                  // keyboard_pio_s1_agent:rdata_fifo_src_valid -> keyboard_pio_s1_agent_rdata_fifo:in_valid
	wire   [33:0] keyboard_pio_s1_agent_rdata_fifo_src_data;                                   // keyboard_pio_s1_agent:rdata_fifo_src_data -> keyboard_pio_s1_agent_rdata_fifo:in_data
	wire          keyboard_pio_s1_agent_rdata_fifo_src_ready;                                  // keyboard_pio_s1_agent_rdata_fifo:in_ready -> keyboard_pio_s1_agent:rdata_fifo_src_ready
	wire   [31:0] code_rdy_pio_s1_agent_m0_readdata;                                           // code_rdy_pio_s1_translator:uav_readdata -> code_rdy_pio_s1_agent:m0_readdata
	wire          code_rdy_pio_s1_agent_m0_waitrequest;                                        // code_rdy_pio_s1_translator:uav_waitrequest -> code_rdy_pio_s1_agent:m0_waitrequest
	wire          code_rdy_pio_s1_agent_m0_debugaccess;                                        // code_rdy_pio_s1_agent:m0_debugaccess -> code_rdy_pio_s1_translator:uav_debugaccess
	wire   [20:0] code_rdy_pio_s1_agent_m0_address;                                            // code_rdy_pio_s1_agent:m0_address -> code_rdy_pio_s1_translator:uav_address
	wire    [3:0] code_rdy_pio_s1_agent_m0_byteenable;                                         // code_rdy_pio_s1_agent:m0_byteenable -> code_rdy_pio_s1_translator:uav_byteenable
	wire          code_rdy_pio_s1_agent_m0_read;                                               // code_rdy_pio_s1_agent:m0_read -> code_rdy_pio_s1_translator:uav_read
	wire          code_rdy_pio_s1_agent_m0_readdatavalid;                                      // code_rdy_pio_s1_translator:uav_readdatavalid -> code_rdy_pio_s1_agent:m0_readdatavalid
	wire          code_rdy_pio_s1_agent_m0_lock;                                               // code_rdy_pio_s1_agent:m0_lock -> code_rdy_pio_s1_translator:uav_lock
	wire   [31:0] code_rdy_pio_s1_agent_m0_writedata;                                          // code_rdy_pio_s1_agent:m0_writedata -> code_rdy_pio_s1_translator:uav_writedata
	wire          code_rdy_pio_s1_agent_m0_write;                                              // code_rdy_pio_s1_agent:m0_write -> code_rdy_pio_s1_translator:uav_write
	wire    [2:0] code_rdy_pio_s1_agent_m0_burstcount;                                         // code_rdy_pio_s1_agent:m0_burstcount -> code_rdy_pio_s1_translator:uav_burstcount
	wire          code_rdy_pio_s1_agent_rf_source_valid;                                       // code_rdy_pio_s1_agent:rf_source_valid -> code_rdy_pio_s1_agent_rsp_fifo:in_valid
	wire  [118:0] code_rdy_pio_s1_agent_rf_source_data;                                        // code_rdy_pio_s1_agent:rf_source_data -> code_rdy_pio_s1_agent_rsp_fifo:in_data
	wire          code_rdy_pio_s1_agent_rf_source_ready;                                       // code_rdy_pio_s1_agent_rsp_fifo:in_ready -> code_rdy_pio_s1_agent:rf_source_ready
	wire          code_rdy_pio_s1_agent_rf_source_startofpacket;                               // code_rdy_pio_s1_agent:rf_source_startofpacket -> code_rdy_pio_s1_agent_rsp_fifo:in_startofpacket
	wire          code_rdy_pio_s1_agent_rf_source_endofpacket;                                 // code_rdy_pio_s1_agent:rf_source_endofpacket -> code_rdy_pio_s1_agent_rsp_fifo:in_endofpacket
	wire          code_rdy_pio_s1_agent_rsp_fifo_out_valid;                                    // code_rdy_pio_s1_agent_rsp_fifo:out_valid -> code_rdy_pio_s1_agent:rf_sink_valid
	wire  [118:0] code_rdy_pio_s1_agent_rsp_fifo_out_data;                                     // code_rdy_pio_s1_agent_rsp_fifo:out_data -> code_rdy_pio_s1_agent:rf_sink_data
	wire          code_rdy_pio_s1_agent_rsp_fifo_out_ready;                                    // code_rdy_pio_s1_agent:rf_sink_ready -> code_rdy_pio_s1_agent_rsp_fifo:out_ready
	wire          code_rdy_pio_s1_agent_rsp_fifo_out_startofpacket;                            // code_rdy_pio_s1_agent_rsp_fifo:out_startofpacket -> code_rdy_pio_s1_agent:rf_sink_startofpacket
	wire          code_rdy_pio_s1_agent_rsp_fifo_out_endofpacket;                              // code_rdy_pio_s1_agent_rsp_fifo:out_endofpacket -> code_rdy_pio_s1_agent:rf_sink_endofpacket
	wire          code_rdy_pio_s1_agent_rdata_fifo_src_valid;                                  // code_rdy_pio_s1_agent:rdata_fifo_src_valid -> code_rdy_pio_s1_agent_rdata_fifo:in_valid
	wire   [33:0] code_rdy_pio_s1_agent_rdata_fifo_src_data;                                   // code_rdy_pio_s1_agent:rdata_fifo_src_data -> code_rdy_pio_s1_agent_rdata_fifo:in_data
	wire          code_rdy_pio_s1_agent_rdata_fifo_src_ready;                                  // code_rdy_pio_s1_agent_rdata_fifo:in_ready -> code_rdy_pio_s1_agent:rdata_fifo_src_ready
	...
	wire          keyboard_pio_s1_agent_rp_valid;                                              // keyboard_pio_s1_agent:rp_valid -> router_010:sink_valid
	wire  [117:0] keyboard_pio_s1_agent_rp_data;                                               // keyboard_pio_s1_agent:rp_data -> router_010:sink_data
	wire          keyboard_pio_s1_agent_rp_ready;                                              // router_010:sink_ready -> keyboard_pio_s1_agent:rp_ready
	wire          keyboard_pio_s1_agent_rp_startofpacket;                                      // keyboard_pio_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire          keyboard_pio_s1_agent_rp_endofpacket;                                        // keyboard_pio_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire          code_rdy_pio_s1_agent_rp_valid;                                              // code_rdy_pio_s1_agent:rp_valid -> router_011:sink_valid
	wire  [117:0] code_rdy_pio_s1_agent_rp_data;                                               // code_rdy_pio_s1_agent:rp_data -> router_011:sink_data
	wire          code_rdy_pio_s1_agent_rp_ready;                                              // router_011:sink_ready -> code_rdy_pio_s1_agent:rp_ready
	wire          code_rdy_pio_s1_agent_rp_startofpacket;                                      // code_rdy_pio_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire          code_rdy_pio_s1_agent_rp_endofpacket;                                        // code_rdy_pio_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire   [10:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> LEDs_s1_burst_adapter:sink0_channel
	...
	wire   [10:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> HEX3_HEX0_s1_burst_adapter:sink0_channel
	...
	wire   [10:0] cmd_mux_006_src_channel;                                                     // cmd_mux_006:src_channel -> Slider_Switches_s1_burst_adapter:sink0_channel
	...
	wire   [10:0] cmd_mux_007_src_channel;                                                     // cmd_mux_007:src_channel -> Pushbuttons_s1_burst_adapter:sink0_channel
	...
	wire          cmd_mux_008_src_valid;                                                       // cmd_mux_008:src_valid -> keyboard_pio_s1_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_008_src_data;                                                        // cmd_mux_008:src_data -> keyboard_pio_s1_burst_adapter:sink0_data
	wire          cmd_mux_008_src_ready;                                                       // keyboard_pio_s1_burst_adapter:sink0_ready -> cmd_mux_008:src_ready
	wire   [10:0] cmd_mux_008_src_channel;                                                     // cmd_mux_008:src_channel -> keyboard_pio_s1_burst_adapter:sink0_channel
	wire          cmd_mux_008_src_startofpacket;                                               // cmd_mux_008:src_startofpacket -> keyboard_pio_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                                 // cmd_mux_008:src_endofpacket -> keyboard_pio_s1_burst_adapter:sink0_endofpacket
	wire          keyboard_pio_s1_burst_adapter_source0_valid;                                 // keyboard_pio_s1_burst_adapter:source0_valid -> keyboard_pio_s1_agent:cp_valid
	wire  [117:0] keyboard_pio_s1_burst_adapter_source0_data;                                  // keyboard_pio_s1_burst_adapter:source0_data -> keyboard_pio_s1_agent:cp_data
	wire          keyboard_pio_s1_burst_adapter_source0_ready;                                 // keyboard_pio_s1_agent:cp_ready -> keyboard_pio_s1_burst_adapter:source0_ready
	wire   [10:0] keyboard_pio_s1_burst_adapter_source0_channel;                               // keyboard_pio_s1_burst_adapter:source0_channel -> keyboard_pio_s1_agent:cp_channel
	wire          keyboard_pio_s1_burst_adapter_source0_startofpacket;                         // keyboard_pio_s1_burst_adapter:source0_startofpacket -> keyboard_pio_s1_agent:cp_startofpacket
	wire          keyboard_pio_s1_burst_adapter_source0_endofpacket;                           // keyboard_pio_s1_burst_adapter:source0_endofpacket -> keyboard_pio_s1_agent:cp_endofpacket
	wire          cmd_mux_009_src_valid;                                                       // cmd_mux_009:src_valid -> code_rdy_pio_s1_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_009_src_data;                                                        // cmd_mux_009:src_data -> code_rdy_pio_s1_burst_adapter:sink0_data
	wire          cmd_mux_009_src_ready;                                                       // code_rdy_pio_s1_burst_adapter:sink0_ready -> cmd_mux_009:src_ready
	wire   [10:0] cmd_mux_009_src_channel;                                                     // cmd_mux_009:src_channel -> code_rdy_pio_s1_burst_adapter:sink0_channel
	wire          cmd_mux_009_src_startofpacket;                                               // cmd_mux_009:src_startofpacket -> code_rdy_pio_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_009_src_endofpacket;                                                 // cmd_mux_009:src_endofpacket -> code_rdy_pio_s1_burst_adapter:sink0_endofpacket
	wire          code_rdy_pio_s1_burst_adapter_source0_valid;                                 // code_rdy_pio_s1_burst_adapter:source0_valid -> code_rdy_pio_s1_agent:cp_valid
	wire  [117:0] code_rdy_pio_s1_burst_adapter_source0_data;                                  // code_rdy_pio_s1_burst_adapter:source0_data -> code_rdy_pio_s1_agent:cp_data
	wire          code_rdy_pio_s1_burst_adapter_source0_ready;                                 // code_rdy_pio_s1_agent:cp_ready -> code_rdy_pio_s1_burst_adapter:source0_ready
	wire   [10:0] code_rdy_pio_s1_burst_adapter_source0_channel;                               // code_rdy_pio_s1_burst_adapter:source0_channel -> code_rdy_pio_s1_agent:cp_channel
	wire          code_rdy_pio_s1_burst_adapter_source0_startofpacket;                         // code_rdy_pio_s1_burst_adapter:source0_startofpacket -> code_rdy_pio_s1_agent:cp_startofpacket
	wire          code_rdy_pio_s1_burst_adapter_source0_endofpacket;                           // code_rdy_pio_s1_burst_adapter:source0_endofpacket -> code_rdy_pio_s1_agent:cp_endofpacket
	...
	wire          keyboard_pio_s1_agent_rdata_fifo_out_valid;                                  // keyboard_pio_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] keyboard_pio_s1_agent_rdata_fifo_out_data;                                   // keyboard_pio_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_008:in_0_data
	wire          keyboard_pio_s1_agent_rdata_fifo_out_ready;                                  // avalon_st_adapter_008:in_0_ready -> keyboard_pio_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_008_out_0_valid;                                           // avalon_st_adapter_008:out_0_valid -> keyboard_pio_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_008_out_0_data;                                            // avalon_st_adapter_008:out_0_data -> keyboard_pio_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_008_out_0_ready;                                           // keyboard_pio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire    [0:0] avalon_st_adapter_008_out_0_error;                                           // avalon_st_adapter_008:out_0_error -> keyboard_pio_s1_agent:rdata_fifo_sink_error
	wire          code_rdy_pio_s1_agent_rdata_fifo_out_valid;                                  // code_rdy_pio_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_009:in_0_valid
	wire   [33:0] code_rdy_pio_s1_agent_rdata_fifo_out_data;                                   // code_rdy_pio_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_009:in_0_data
	wire          code_rdy_pio_s1_agent_rdata_fifo_out_ready;                                  // avalon_st_adapter_009:in_0_ready -> code_rdy_pio_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_009_out_0_valid;                                           // avalon_st_adapter_009:out_0_valid -> code_rdy_pio_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_009_out_0_data;                                            // avalon_st_adapter_009:out_0_data -> code_rdy_pio_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_009_out_0_ready;                                           // code_rdy_pio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire    [0:0] avalon_st_adapter_009_out_0_error;                                           // avalon_st_adapter_009:out_0_error -> code_rdy_pio_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) keyboard_pio_s1_translator (
		.clk                    (System_PLL_sys_clk_clk),                      //                      clk.clk
		.reset                  (AV_Config_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (keyboard_pio_s1_agent_m0_address),            // avalon_universal_slave_0.address
		.uav_burstcount         (keyboard_pio_s1_agent_m0_burstcount),         //                         .burstcount
		.uav_read               (keyboard_pio_s1_agent_m0_read),               //                         .read
		.uav_write              (keyboard_pio_s1_agent_m0_write),              //                         .write
		.uav_waitrequest        (keyboard_pio_s1_agent_m0_waitrequest),        //                         .waitrequest
		.uav_readdatavalid      (keyboard_pio_s1_agent_m0_readdatavalid),      //                         .readdatavalid
		.uav_byteenable         (keyboard_pio_s1_agent_m0_byteenable),         //                         .byteenable
		.uav_readdata           (keyboard_pio_s1_agent_m0_readdata),           //                         .readdata
		.uav_writedata          (keyboard_pio_s1_agent_m0_writedata),          //                         .writedata
		.uav_lock               (keyboard_pio_s1_agent_m0_lock),               //                         .lock
		.uav_debugaccess        (keyboard_pio_s1_agent_m0_debugaccess),        //                         .debugaccess
		.av_address             (keyboard_pio_s1_address),                     //      avalon_anti_slave_0.address
		.av_readdata            (keyboard_pio_s1_readdata),                    //                         .readdata
		.av_write               (),                                            //              (terminated)
		.av_read                (),                                            //              (terminated)
		.av_writedata           (),                                            //              (terminated)
		.av_begintransfer       (),                                            //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) code_rdy_pio_s1_translator (
		.clk                    (System_PLL_sys_clk_clk),                      //                      clk.clk
		.reset                  (AV_Config_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (code_rdy_pio_s1_agent_m0_address),            // avalon_universal_slave_0.address
		.uav_burstcount         (code_rdy_pio_s1_agent_m0_burstcount),         //                         .burstcount
		.uav_read               (code_rdy_pio_s1_agent_m0_read),               //                         .read
		.uav_write              (code_rdy_pio_s1_agent_m0_write),              //                         .write
		.uav_waitrequest        (code_rdy_pio_s1_agent_m0_waitrequest),        //                         .waitrequest
		.uav_readdatavalid      (code_rdy_pio_s1_agent_m0_readdatavalid),      //                         .readdatavalid
		.uav_byteenable         (code_rdy_pio_s1_agent_m0_byteenable),         //                         .byteenable
		.uav_readdata           (code_rdy_pio_s1_agent_m0_readdata),           //                         .readdata
		.uav_writedata          (code_rdy_pio_s1_agent_m0_writedata),          //                         .writedata
		.uav_lock               (code_rdy_pio_s1_agent_m0_lock),               //                         .lock
		.uav_debugaccess        (code_rdy_pio_s1_agent_m0_debugaccess),        //                         .debugaccess
		.av_address             (code_rdy_pio_s1_address),                     //      avalon_anti_slave_0.address
		.av_readdata            (code_rdy_pio_s1_readdata),                    //                         .readdata
		.av_write               (),                                            //              (terminated)
		.av_read                (),                                            //              (terminated)
		.av_writedata           (),                                            //              (terminated)
		.av_begintransfer       (),                                            //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) keyboard_pio_s1_agent (
		.clk                     (System_PLL_sys_clk_clk),                              //             clk.clk
		.reset                   (AV_Config_reset_reset_bridge_in_reset_reset),         //       clk_reset.reset
		.m0_address              (keyboard_pio_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (keyboard_pio_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (keyboard_pio_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (keyboard_pio_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (keyboard_pio_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (keyboard_pio_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (keyboard_pio_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (keyboard_pio_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (keyboard_pio_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (keyboard_pio_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (keyboard_pio_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (keyboard_pio_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (keyboard_pio_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (keyboard_pio_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (keyboard_pio_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (keyboard_pio_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (keyboard_pio_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (keyboard_pio_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (keyboard_pio_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (keyboard_pio_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (keyboard_pio_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (keyboard_pio_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (keyboard_pio_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (keyboard_pio_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (keyboard_pio_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (keyboard_pio_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (keyboard_pio_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (keyboard_pio_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (keyboard_pio_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (keyboard_pio_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (keyboard_pio_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (keyboard_pio_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_008_out_0_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_008_out_0_valid),                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_008_out_0_data),                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_008_out_0_error),                   //                .error
		.rdata_fifo_src_ready    (keyboard_pio_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (keyboard_pio_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (keyboard_pio_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                               //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                 //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) keyboard_pio_s1_agent_rsp_fifo (
		.clk               (System_PLL_sys_clk_clk),                           //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		.in_data           (keyboard_pio_s1_agent_rf_source_data),             //        in.data
		.in_valid          (keyboard_pio_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (keyboard_pio_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (keyboard_pio_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (keyboard_pio_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (keyboard_pio_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (keyboard_pio_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (keyboard_pio_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (keyboard_pio_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (keyboard_pio_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) keyboard_pio_s1_agent_rdata_fifo (
		.clk               (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (keyboard_pio_s1_agent_rdata_fifo_src_data),   //        in.data
		.in_valid          (keyboard_pio_s1_agent_rdata_fifo_src_valid),  //          .valid
		.in_ready          (keyboard_pio_s1_agent_rdata_fifo_src_ready),  //          .ready
		.out_data          (keyboard_pio_s1_agent_rdata_fifo_out_data),   //       out.data
		.out_valid         (keyboard_pio_s1_agent_rdata_fifo_out_valid),  //          .valid
		.out_ready         (keyboard_pio_s1_agent_rdata_fifo_out_ready),  //          .ready
		.csr_address       (2'b00),                                       // (terminated)
		.csr_read          (1'b0),                                        // (terminated)
		.csr_write         (1'b0),                                        // (terminated)
		.csr_readdata      (),                                            // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) code_rdy_pio_s1_agent (
		.clk                     (System_PLL_sys_clk_clk),                              //             clk.clk
		.reset                   (AV_Config_reset_reset_bridge_in_reset_reset),         //       clk_reset.reset
		.m0_address              (code_rdy_pio_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (code_rdy_pio_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (code_rdy_pio_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (code_rdy_pio_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (code_rdy_pio_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (code_rdy_pio_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (code_rdy_pio_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (code_rdy_pio_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (code_rdy_pio_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (code_rdy_pio_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (code_rdy_pio_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (code_rdy_pio_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (code_rdy_pio_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (code_rdy_pio_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (code_rdy_pio_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (code_rdy_pio_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (code_rdy_pio_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (code_rdy_pio_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (code_rdy_pio_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (code_rdy_pio_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (code_rdy_pio_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (code_rdy_pio_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (code_rdy_pio_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (code_rdy_pio_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (code_rdy_pio_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (code_rdy_pio_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (code_rdy_pio_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (code_rdy_pio_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (code_rdy_pio_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (code_rdy_pio_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (code_rdy_pio_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (code_rdy_pio_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_009_out_0_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_009_out_0_valid),                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_009_out_0_data),                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_009_out_0_error),                   //                .error
		.rdata_fifo_src_ready    (code_rdy_pio_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (code_rdy_pio_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (code_rdy_pio_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                               //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                 //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) code_rdy_pio_s1_agent_rsp_fifo (
		.clk               (System_PLL_sys_clk_clk),                           //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		.in_data           (code_rdy_pio_s1_agent_rf_source_data),             //        in.data
		.in_valid          (code_rdy_pio_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (code_rdy_pio_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (code_rdy_pio_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (code_rdy_pio_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (code_rdy_pio_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (code_rdy_pio_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (code_rdy_pio_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (code_rdy_pio_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (code_rdy_pio_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) code_rdy_pio_s1_agent_rdata_fifo (
		.clk               (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (code_rdy_pio_s1_agent_rdata_fifo_src_data),   //        in.data
		.in_valid          (code_rdy_pio_s1_agent_rdata_fifo_src_valid),  //          .valid
		.in_ready          (code_rdy_pio_s1_agent_rdata_fifo_src_ready),  //          .ready
		.out_data          (code_rdy_pio_s1_agent_rdata_fifo_out_data),   //       out.data
		.out_valid         (code_rdy_pio_s1_agent_rdata_fifo_out_valid),  //          .valid
		.out_ready         (code_rdy_pio_s1_agent_rdata_fifo_out_ready),  //          .ready
		.csr_address       (2'b00),                                       // (terminated)
		.csr_read          (1'b0),                                        // (terminated)
		.csr_write         (1'b0),                                        // (terminated)
		.csr_readdata      (),                                            // (terminated)
	...
	Computer_System_mm_interconnect_2_router_002 router_010 (
		.sink_ready         (keyboard_pio_s1_agent_rp_ready),              //      sink.ready
		.sink_valid         (keyboard_pio_s1_agent_rp_valid),              //          .valid
		.sink_data          (keyboard_pio_s1_agent_rp_data),               //          .data
		.sink_startofpacket (keyboard_pio_s1_agent_rp_startofpacket),      //          .startofpacket
		.sink_endofpacket   (keyboard_pio_s1_agent_rp_endofpacket),        //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset              (AV_Config_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Computer_System_mm_interconnect_2_router_002 router_011 (
		.sink_ready         (code_rdy_pio_s1_agent_rp_ready),              //      sink.ready
		.sink_valid         (code_rdy_pio_s1_agent_rp_valid),              //          .valid
		.sink_data          (code_rdy_pio_s1_agent_rp_data),               //          .data
		.sink_startofpacket (code_rdy_pio_s1_agent_rp_startofpacket),      //          .startofpacket
		.sink_endofpacket   (code_rdy_pio_s1_agent_rp_endofpacket),        //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                      //       clk.clk
		.reset              (AV_Config_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (keyboard_pio_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (keyboard_pio_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (keyboard_pio_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (keyboard_pio_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (keyboard_pio_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (keyboard_pio_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (code_rdy_pio_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (code_rdy_pio_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (code_rdy_pio_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (code_rdy_pio_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (code_rdy_pio_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (code_rdy_pio_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	Computer_System_mm_interconnect_1_avalon_st_adapter_002 #(
		...
		.in_clk_0_clk   (System_PLL_sys_clk_clk),                      // in_clk_0.clk
		.in_rst_0_reset (AV_Config_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (keyboard_pio_s1_agent_rdata_fifo_out_data),   //     in_0.data
		.in_0_valid     (keyboard_pio_s1_agent_rdata_fifo_out_valid),  //         .valid
		.in_0_ready     (keyboard_pio_s1_agent_rdata_fifo_out_ready),  //         .ready
	...
	Computer_System_mm_interconnect_1_avalon_st_adapter_002 #(
		...
		.in_clk_0_clk   (System_PLL_sys_clk_clk),                      // in_clk_0.clk
		.in_rst_0_reset (AV_Config_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (code_rdy_pio_s1_agent_rdata_fifo_out_data),   //     in_0.data
		.in_0_valid     (code_rdy_pio_s1_agent_rdata_fifo_out_valid),  //         .valid
		.in_0_ready     (code_rdy_pio_s1_agent_rdata_fifo_out_ready),  //         .ready
